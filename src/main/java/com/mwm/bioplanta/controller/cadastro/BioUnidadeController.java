...
import com.mwm.bioplanta.service.cadastro.BioUnidadeService;
...
public class BioUnidadeController {
    ...
    private final BioUnidadeService bioUnidadeService;

    public BioUnidadeController(BioUnidadeService bioUnidadeService) {
        this.bioUnidadeService = bioUnidadeService;
    }
    @GetMapping

    @Operation(summary = "Obter todas as unidades bio")
    public List<BioUnidade> listarTodos() {
        return bioUnidadeService.listarTodos();
    }

    @GetMapping("/{id}")
    @Operation(summary = "Obter unidade bio por ID")
    public ResponseEntity<BioUnidade> obterPorId(@PathVariable Long id) {
        Optional<BioUnidade> bioUnidade = bioUnidadeService.obterPorId(id);
    ...
    public BioUnidade criar(@RequestBody BioUnidade bioUnidade) {
        return bioUnidadeService.criar(bioUnidade);
    }
    ...
    public ResponseEntity<BioUnidade> atualizar(@PathVariable Long id, @RequestBody BioUnidade bioUnidade) {
        return bioUnidadeService.atualizar(id, bioUnidade)
    ...
    public ResponseEntity<Void> deletar(@PathVariable Long id) {
        if (!bioUnidadeService.deletar(id)) {
