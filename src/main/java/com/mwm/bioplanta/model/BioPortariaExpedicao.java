...
@Entity
@Table(name = "bio_portaria_expedicao")
@Data
public class BioPortariaExpedicao {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_portaria_expedicao")
    @SequenceGenerator(name = "seq_portaria_expedicao", sequenceName = "seq_portaria_expedicao", allocationSize = 1)
    private Long id;
