...
import com.mwm.bioplanta.dto.PortariaAbastecimentoRequestDTO;
import com.mwm.bioplanta.dto.PortariaAbastecimentoDTO;
...
public class PortariaAbastecimentoService {
    ...
    public PortariaAbastecimentoDTO registrarAbastecimento(PortariaAbastecimentoRequestDTO request) {
        ...
        if (request.getData_saida() != null && !request.getData_saida().isEmpty()) registro.setDataSaida(LocalDate.parse(request.getData_saida()));
        if (request.getHora_saida() != null && !request.getHora_saida().isEmpty()) registro.setHoraSaida(LocalTime.parse(request.getHora_saida()));
